      ...
      <div className="contact-extra__inner">
        ...
        <nav className="contact-extra__socials reveal" aria-label="Social media links">
          ...
          <div className="contact-extra__socials-grid">
            ...
            <a href="https://github.com/dev-erickydias" target="_blank" rel="noopener noreferrer" className="contact-extra__social">
              <Image src="/image/github.svg" alt="" width={20} height={20} aria-hidden="true" />
              <span>GitHub</span>
            </a>
            <a href="https://www.instagram.com/ericky_dias/" target="_blank" rel="noopener noreferrer" className="contact-extra__social">
              <Image src="/image/instagram.svg" alt="" width={20} height={20} aria-hidden="true" />
              <span>Instagram</span>
            </a>
            <a href="https://discord.com/users/344918178679357441" target="_blank" rel="noopener noreferrer" className="contact-extra__social">
