    ...
    return (
      <section id="projects" className="projects" aria-label="Projects">
        <div className="projects__inner">
          ...
          <div className="projects__grid stagger-children" aria-busy="true" aria-label="Loading projects">
            {[1, 2, 3, 4, 5, 6].map((i) => (
    ...
    return (
      <section id="projects" className="projects" aria-label="Projects">
        <div className="projects__inner">
          ...
          <p className="projects__error" role="alert">Failed to load projects. Please try again later.</p>
        </div>
      </section>
    );
  }
